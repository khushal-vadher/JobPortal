...
//  console.log(current.personaldetail[0]);
//  const pd = current.personaldetail[current.personaldetail.length]
  const back = () => {
    navigate('/')
  }
  return (
      ...
      <div class="tr-breadcrumb bg-image section-before">
        ...
        {/* <div class="container">
            ...
            <div class="breadcrumb-info text-center">
              ...
              <div class="user-title">
                <h1>{current.personaldetail[current.personaldetail.length - 1].Firstname} {current.personaldetail[0].Lastname}</h1>
              </div>
              <ul class="job-meta tr-list list-inline">
                <li><i class="fa fa-map-marker" aria-hidden="true"></i>{current.personaldetail[0].City},{current.personaldetail[0].Country}</li>
                <li><i class="fa fa-phone" aria-hidden="true"></i>{current.personaldetail[0].Mobile}</li>
                <li><i class="fa fa-envelope" aria-hidden="true"></i><a href="#"><span class="__cf_email__"
                  data-cfemail="f8929097969c979db89f95999194d69b9795">{email}</span></a></li>
                ...
                <li class="language-proficiency media">
                  ...
                  <div class="media-body">
                    ...
                    {current.skill?.map((add, i) => (
                      <ul class="tr-list" key={i}>
                        {/* <p>Java</p>{add.Skills[0].skill1 && <p>Yes</p>} */}
                        {add.Skills[0].skill1}
                        {add.Skills[0].skill2}
                        {add.Skills[0].skill3}
                        {add.Skills[0].skill4}
